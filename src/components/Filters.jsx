...
export default function Filters({ filterFunc, sortFunc, userId }) {
  ...
  const filterOptions = [
    ...
    { value: "mimeType = 'application/vnd.google-apps.folder' or mimeType contains 'text/'", label: 'Text' },
    {
     ...
     + " and not mimeType = 'application/vnd.google-apps.presentation' and not mimeType = 'application/vnd.google-apps.spreadsheet' and not mimeType = 'application/vnd.google-apps.document'",
      label: 'Misc',
    },
